...
**Milestone:** v0.8.0 DCM for Evoked Responses (EEG/MEG ERP). **IN PROGRESS — Phase 33 Wave 1 (Plan 33-01) ✅ COMPLETE 2026-06-25.** ROADMAP created (Phases 33-36; 25/25 reqs mapped to one phase each).
**Phase 33 — CMC Core + spm_int_L Integrator + Single-Source Parity: IN PROGRESS (Wave 1 done; Waves 2-3 pending).**
