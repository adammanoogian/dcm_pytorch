...
**Milestone:** v0.8.0 DCM for Evoked Responses (EEG/MEG ERP). **IN PROGRESS — Phase 33 Waves 1-2 (Plans 33-01, 33-02) ✅ COMPLETE.** ROADMAP created (Phases 33-36; 25/25 reqs mapped to one phase each).
**Phase 33 — CMC Core + spm_int_L Integrator + Single-Source Parity: IN PROGRESS (Waves 1-2 done; Wave 3 / Plan 33-03 parity gate pending).**
