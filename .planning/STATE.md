...
**Current focus:** v0.6.0 Latent Circuit DCM -- distill trained RNN latent dynamics into bilinear DCM circuits with posterior uncertainty. Defining requirements.

## Current Position

**Milestone:** v0.6.0 Latent Circuit DCM (started 2026-05-24)
**Phase:** Not started (defining requirements)
**Plan:** --
**Status:** Defining requirements
**Last activity:** 2026-05-24 -- Milestone v0.6.0 started. Approach 1: distill neural-data-prediction RNN into interpretable bilinear DCM. Direct observation model (no hemodynamic convolution). Paper-ready deliverable with Langdon & Engel 2025 comparison.

**Prior milestones in flight:**
- v0.5.0: Phase 18 COMPLETE; Phase 19 pending
- v0.3.0: Phase 16.1 pending (RECOV-04 B-RMSE diagnostic)

**Previous v0.5.0 position:**
...
Progress: v0.1.0 [██████████] 100% | v0.2.0 [██████████] 100% | v0.3.0 [██████████] Phases 13-15 complete; 16.1 pending | v0.4.0 [██████████] Phase 17 complete | v0.5.0 [██░░░░░░░░] Phase 18 complete; Phase 19 pending | v0.6.0 [░░░░░░░░░░] Defining requirements
