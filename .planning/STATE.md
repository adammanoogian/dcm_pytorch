...
**Phase 36 — erp_dcm_model + amortized wiring + 5-source MMN precision-sweep demo: IN PROGRESS. 36-01 (models/guides, parallel agent) committing on this branch (7bd3b71, d34caa6, ...). 36-02 ✅ DONE (the public MMN net + actinf_physics adapter).**
