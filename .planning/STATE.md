...
**Milestone:** v0.8.0 DCM for Evoked Responses (EEG/MEG ERP). **IN PROGRESS — Phase 33 ✅ COMPLETE; Phase 34 Waves 1+2 (Plans 34-01, 34-02) ✅ COMPLETE — the pure-torch CMC network core + C4 dual-B precision mechanism are GREEN on the laptop, and the byte-frozen 5-source MMN SPM12 fixtures are generated on M3 + committed to git.** ROADMAP created (Phases 33-36; 25/25 reqs mapped to one phase each).
**Phase 34 — Extrinsic Coupling, Condition B & Multi-Source Evoked: Waves 1+2 of 3 DONE (Plans 34-01, 34-02).** Next: Wave 3 (34-03 multi-source parity ladder — asserts pure-torch against the committed fixture, laptop, gated on the .mat).
