...
**Milestone:** v0.8.0 DCM for Evoked Responses (EEG/MEG ERP). **IN PROGRESS — Phase 33 ✅ COMPLETE; Phase 34 ✅ ALL 3 WAVES COMPLETE; Phase 35 ✅ ALL 3 WAVES COMPLETE; Phase 36 ✅ ALL 3 PLANS COMPLETE — 36-01 ✅ DONE (ERP-DCM Pyro *DCM* + *amortized*) + 36-02 ✅ DONE (public MMN net + actinf_physics adapter) + 36-03 ✅ DONE (gated MMN precision-sweep CAPSTONE demo). v0.8.0 CAPSTONE delivered. `/gsd:verify-phase 36` outstanding; orchestrator to add a follow-up ECD frontal-topography phase (deferred Fact 6).** ROADMAP created (Phases 33-36; 25/25 reqs mapped to one phase each).
