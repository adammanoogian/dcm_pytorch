...
**Milestone:** v0.8.0 DCM for Evoked Responses (EEG/MEG ERP). **IN PROGRESS — Phase 33 ✅ COMPLETE; Phase 34 ✅ ALL 3 WAVES COMPLETE; Phase 35 ✅ ALL 3 WAVES COMPLETE; Phase 36 ⏳ IN PROGRESS — 36-01 ✅ DONE (ERP-DCM is now a Pyro *DCM* + an *amortized* model) + 36-02 ✅ DONE (public MMN net + actinf_physics adapter); 36-03 (precision-sweep demo) NEXT.** ROADMAP created (Phases 33-36; 25/25 reqs mapped to one phase each).
...
**Phase 36 — erp_dcm_model + amortized wiring + 5-source MMN precision-sweep demo: IN PROGRESS. 36-01 ✅ DONE (erp_dcm_model + ERPDCMPacker + ErpSummaryNet + amortized_erp_dcm_model; LAPTOP unit + M3 amortized fit green). 36-02 ✅ DONE (public MMN net + actinf_physics adapter). 36-03 (precision-sweep demo) NEXT.**
