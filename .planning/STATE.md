...
**Milestone:** v0.8.0 DCM for Evoked Responses (EEG/MEG ERP). **IN PROGRESS — Phase 33 Waves 1-3 (Plans 33-01, 33-02, 33-03) ✅ COMPLETE — the SPM12 single-source parity gate (CMC-06) is GREEN.** ROADMAP created (Phases 33-36; 25/25 reqs mapped to one phase each).
