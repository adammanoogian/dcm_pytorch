...
| 002 | Structure-audit migration waves 1-5 (janitorial cleanup + docs/ 5-subfolder reorg + CLAUDE.md sync + top-level config.py + scripts/debug/ + models/→checkpoints/ rename) | 2026-04-29 | 33e03e1 | [002-structure-audit-migration-waves-1-5](./quick/002-structure-audit-migration-waves-1-5/) |
...
Last session: 2026-05-21 (Plan 18-02 execution)
Stopped at: Plan 18-02 COMPLETE -- BIDS loader test suite
shipped on `gsd/phase-18-mne-io-test-suite`. 3 round-trip
tests covering load_bids_raw, load_bids_epochs, BAD_ACQ_SKIP.
bids_loader.py created on branch (Rule 3 deviation).
Phase 18 fully complete (15 total IO tests across both plans).

Prior session: 2026-05-21 (Plan 18-01 execution)
Stopped at: Plan 18-01 COMPLETE -- MNE loader test suite
shipped on `gsd/phase-18-mne-io-test-suite`. 12 tests
covering 4 loader functions, CSD math properties, channel
picks, error paths. Source module created on branch (Rule 3).

Earlier session: 2026-04-24 (Plan 17-01 execution)
